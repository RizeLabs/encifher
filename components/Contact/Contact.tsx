    ...
    return (
        <>
            <div className="h-[70vh] px-[5%] py-[2%]">
                <div
                    className="flex flex-col items-center gap-[4rem] h-full w-full pt-[8%] border-gradient-b"
                >
                    ...
                    <div className="flex items-center justify-between gap-1 w-[37%]">
                        <span className='h-full w-[59.5%] input-gradient'>
                            <input
