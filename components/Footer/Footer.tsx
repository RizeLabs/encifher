          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Image
                ...
                height={32}
                alt="Encifher Logo"
                className="w-[100px] sm:w-[139px] h-[24px]"
              />
            </div>
        ...
        <div className="w-full md:w-[40%] ml-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-sm md:text-[14px] text-white/50 mb-2">
                SOCIALS
              </span>
              <Link
                href="https://x.com/encifherio"
                target="_blank"
                className=" text-base md:text-[16px] mb-1"
              >
                X/TWITTER
              </Link>
              <Link
              ...
              <Link
                href="https://t.me/+ZWHGMW4ZHXQwYTZl"
                target="_blank"
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link
                href="https://app.encifher.io/terms"
                target="_blank"
                className=" text-base md:text-[16px] mb-1"
              >
                TERMS OF SERVICE
              ...
              <Link
                href="https://app.encifher.io/privacy"
                target="_blank"
                className=" text-base md:text-[16px] mb-1"
              >
                PRIVACY POLICY
