...
export default function Navbar() {
    ...
    return (
        <div
            className="w-[100%] h-[3%] flex justify-between items-center px-4 md:px-10 py-4 md:py-7 sticky top-0 z-40 bg-[#0c0c0c]/90 backdrop-blur-md"
        >
                ...
                {isOpen && (
                    ...
                    >
                        <div className="absolute top-1/3 left-[10%] -translate-y-[30%] flex flex-col gap-4 w-full justify-center" ref={buttonsRef}>
                            ...
                            >
                                <Button text="Launch App" onClick={() => window.open("https://app.encifher.io", "_blank")} className="w-[80%] px-4 py-2 text-lg select-none" />
                            </motion.div>
                        </div>
                    </motion.div>
                )}
